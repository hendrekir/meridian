...
def get_signal(db: Session, workspace_id: str) -> dict:
    from modelsv8_0 import Transaction, Customer
...
def get_feature_margins(db: Session, workspace_id: str) -> list:
    from modelsv8_0 import Feature, Transaction
...
def get_customer_margins(
    ...
    from modelsv8_0 import Customer, Transaction
