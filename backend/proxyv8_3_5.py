...
def check_wallet(db: Session, workspace_id: str) -> Tuple[bool, float]:
    ...
    from modelsv8_3_5 import Wallet
...
def record_transaction(
    ...
    from modelsv8_3_5 import Transaction, TransactionType, Wallet, WalletEntry
...
def evaluate_routing_rules(
    ...
    """
    from modelsv8_3_5 import RoutingRule, Budget, Transaction
...
def _eval_trigger(trigger: dict, feature_id, customer_id, tokens, model, db, workspace_id) -> bool:
    from modelsv8_3_5 import Budget, Transaction
    from analyticsv8_3_5 import period_start
    from sqlalchemy import func
...
def _check_budget_alerts(db: Session, workspace_id: str, tx) -> None:
    from modelsv8_3_5 import Budget, Transaction, Alert, AlertType, AlertSeverity, BudgetPolicy
    from analyticsv8_3_5 import period_start
    from sqlalchemy import func
...
def _check_wallet_alerts(db: Session, workspace_id: str) -> None:
    from modelsv8_3_5 import Wallet, Alert, AlertType, AlertSeverity
...
def _maybe_create_alert(db, workspace_id, alert_type, severity, title, body, meta) -> None:
    ...
    from modelsv8_3_5 import Alert
