...
def get_signal(db: Session, workspace_id: str) -> dict:
    from modelsv8_2 import Transaction, Customer
...
def get_feature_margins(db: Session, workspace_id: str) -> list:
    from modelsv8_2 import Feature, Transaction
...
def get_customer_margins(
    ...
    from modelsv8_2 import Customer, Transaction
...
# Current pricing for what-if calculations — same as seed data in indexv8.2.py
_MODEL_PRICING = {
